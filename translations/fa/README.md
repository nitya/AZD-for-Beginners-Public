...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-16T15:21:22+00:00",
...
بر اساس بینش‌های جامعه دیسکورد Azure AI Foundry، **۴۵٪ از توسعه‌دهندگان می‌خواهند از AZD برای بارهای کاری هوش مصنوعی استفاده کنند** اما با چالش‌هایی مواجه می‌شوند از جمله:
...
- **🎥 راهنمای تعاملی**: [مواد کارگاه](workshop/README.md) - یادگیری مبتنی بر مرورگر با محیط DevContainer MkDocs
...
**💡 نتیجه فصل**: استقرار و مدیریت یک راه‌حل چندعاملی هوش مصنوعی آماده تولید با عامل‌های مشتری و موجودی
...
- **یکپارچه‌سازی با GitHub Codespaces**: تنظیم محیط توسعه با یک کلیک
...
- **جریان‌های کاری انتها به انتها هوش مصنوعی** - از توسعه مدل تا استقرار تولیدی با نظارت مناسب
- **بهینه‌سازی هزینه‌ها** - استراتژی‌های تخصیص منابع هوشمند و مقیاس‌پذیری برای بارهای کاری هوش مصنوعی
- **یکپارچه‌سازی با Azure AI Foundry** - اتصال بدون مشکل به کاتالوگ مدل و نقاط پایانی AI Foundry
...
**قالب‌های برنامه آماده تولید که به فصل‌های آموزشی نگاشت شده‌اند**

| قالب | فصل آموزشی | پیچیدگی | نکات کلیدی یادگیری |
|----------|------------------|------------|--------------|
| [**openai-chat-app-quickstart**](https://github.com/Azure-Samples/openai-chat-app-quickstart) | فصل ۲ | ⭐ | الگوهای استقرار اولیه هوش مصنوعی |
...
- [برنامه وب ساده](../../examples/simple-web-app) - الگوهای استقرار اولیه
- [وب‌سایت استاتیک](../../examples/static-site) - استقرار محتوای استاتیک
- [API پایه](../../examples/basic-api) - استقرار API REST
...
- **سؤالات آموزشی**: [جامعه دیسکورد Microsoft Azure](https://discord.gg/microsoft-azure)
...
### بینش‌های جامعه از دیسکورد Azure AI Foundry
