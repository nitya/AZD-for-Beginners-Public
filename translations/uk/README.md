...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-16T16:18:08+00:00",
...
- Розуміння налаштувань сервісів AI
...
- **🎥 Інтерактивний посібник**: [Матеріали семінару](workshop/README.md) - Навчання в браузері з MkDocs * DevContainer Environment
...
- **🔐 Безпека**: Шаблони автентифікації та керованої ідентичності
- **📝 Приклади**: [Приклад додатка для бази даних](../../examples/database-app) - Шаблони налаштування
...
**💡 Результат розділу**: Управляти кількома середовищами з належною автентифікацією та безпекою
...
- Реалізуйте стратегії розгортання "синьо-зелений"

**💡 Результат розділу**: Розгорнути складні додатки з кількома сервісами, використовуючи власні шаблони інфраструктури

---

### 🎯 Розділ 5: Рішення з багатьма агентами AI (Просунутий рівень)
...
**💡 Результат розділу**: Розгорнути та управляти рішенням з багатьма агентами AI для продакшн з агентами клієнтів та інвентаризації
...
- Вирішення специфічних для AI проблем
...
Наші матеріали воркшопу забезпечують структурований, інтерактивний досвід навчання, який доповнює навчальну програму, засновану на розділах. Воркшоп розроблений як для самостійного навчання, так і для занять під керівництвом інструктора.
...
- **Розгортати AI-додатки для виробництва**: Використовувати AZD з сервісами Azure AI Foundry
...
- **🛠️ Лабораторія AI воркшопу**: [Лабораторія AI воркшопу](docs/ai-foundry/ai-workshop-lab.md) - Вправи, орієнтовані на AI
...
- **Інтегровані робочі процеси** - Безперервне налаштування, розгортання та моніторинг додатків
...
- **Безпечне розгортання AI** - Вбудовані шаблони безпеки для AI-сервісів, ключів API та кінцевих точок моделей  
...
|----------|---------|------------|----------|
| [**Почніть з AI-чату**](https://github.com/Azure-Samples/get-started-with-ai-chat) | Розділ 2 | ⭐⭐ | AzureOpenAI + Azure AI Model Inference API + Azure AI Search + Azure Container Apps + Application Insights |
| [**Почніть з AI-агентів**](https://github.com/Azure-Samples/get-started-with-ai-agents) | Розділ 2 | ⭐⭐ | Azure AI Agent Service + AzureOpenAI + Azure AI Search + Azure Container Apps + Application Insights|
...
- [Основний API](../../examples/basic-api) - Розгортання REST API
...
### Практичні воркшопи
- [**Лабораторія AI воркшопу**](docs/ai-foundry/ai-workshop-lab.md) - Зробіть свої AI-рішення готовими до розгортання через AZD (2-3 години)
...
- [**Воркшоп для початківців з AZD**](workshop/README.md) - Повні матеріали практичного воркшопу з інтеграцією GitHub Codespaces
