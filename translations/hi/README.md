...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-16T15:30:55+00:00",
...
3. **समुदाय से जुड़ें**: विशेषज्ञ सहायता के लिए [Azure Discord Communities](https://discord.com/invite/ByRwuEEgH4)
...
- **मल्टी-एजेंट समाधान बनाएं**: जटिल AI आर्किटेक्चर डिप्लॉय करें
...
#### सीखने के संसाधन
- **🎯 यहाँ से शुरू करें**: [Azure AI Foundry एकीकरण](docs/ai-foundry/azure-ai-foundry-integration.md)
...
- **🎥 इंटरएक्टिव गाइड**: [कार्यशाला सामग्री](workshop/README.md) - MkDocs * DevContainer Environment के साथ ब्राउज़र-आधारित सीखना
...
### 🏗️ अध्याय 4: कोड और डिप्लॉयमेंट के रूप में इंफ्रास्ट्रक्चर
...
**💡 अध्याय परिणाम**: पूर्ण उत्पादन क्षमताओं के साथ एंटरप्राइज़-रेडी एप्लिकेशन परिनियोजित करें
...
हमारी कार्यशाला सामग्री ऊपर दिए गए अध्याय-आधारित पाठ्यक्रम को पूरक करने के लिए एक संरचित, इंटरएक्टिव सीखने का अनुभव प्रदान करती है। कार्यशाला को स्व-गति से सीखने और प्रशिक्षक-नेतृत्व वाले सत्रों दोनों के लिए डिज़ाइन किया गया है।

#### 🛠️ कार्यशाला की विशेषताएँ
- **ब्राउज़र-आधारित इंटरफ़ेस**: खोज, कॉपी और थीम सुविधाओं के साथ MkDocs-संचालित कार्यशाला
...
- **कोड के रूप में बुनियादी ढांचा** - Bicep या Terraform का उपयोग करके Azure संसाधनों का प्रबंधन करें  
...
| [**एजेंट्स के साथ अपने कोड को आधुनिक बनाएं**](https://github.com/Azure-Samples/get-started-with-ai-chat) | अध्याय 5 | ⭐⭐⭐ | AzureOpenAI + Azure Agent Service + Semantic Kernel + Azure CosmosDB + Azure Container Apps|
...
| [**संवादी डेटा से अंतर्दृष्टि प्राप्त करें**](https://github.com/Azure-Samples/get-started-with-ai-chat) | अध्याय 8 | ⭐⭐⭐ | AzureOpenAI + AI Search + Semantic Kernel + Azure Agent Service + AI AI Content Understanding|
...
**उत्पादन-रेडी एप्लिकेशन टेम्पलेट्स को सीखने के अध्यायों से जोड़ा गया**
...
- [Enterprise Solutions](../../examples/enterprise) - उत्पादन-रेडी पैटर्न

### बाहरी टेम्पलेट संग्रह
- [**Official AZD Template Gallery**](https://azure.github.io/awesome-azd/) - आधिकारिक और सामुदायिक टेम्पलेट्स का क्यूरेटेड संग्रह
...
- [**Interactive Workshop Guide**](workshop/README.md) - MkDocs और DevContainer Environment के साथ ब्राउज़र-आधारित कार्यशाला
...
- [ ] **अध्याय 4**: कोड और परिनियोजन के रूप में बुनियादी ढांचा ✅
...
1. **व्यावहारिक अभ्यास**: अध्याय का व्यावहारिक परिनियोजन पूरा करें
...
- **पेशेवर कौशल**: एंटरप्राइज़-रेडी परिनियोजन क्षमताएँ  
...
- **शीर्ष चुनौतियाँ**: मल्टी-सर्विस परिनियोजन, क्रेडेंशियल प्रबंधन, उत्पादन तैयारी  
...
- नए AI टेम्पलेट्स के शुरुआती पूर्वावलोकन तक पहुँच प्राप्त करें
- AI परिनियोजन सर्वोत्तम प्रथाओं में योगदान करें
- भविष्य के AI + AZD फीचर विकास को प्रभावित करें

### पाठ्यक्रम में योगदान
हम योगदान का स्वागत करते हैं! कृपया हमारे [Contributing Guide](CONTRIBUTING.md) को पढ़ें ताकि आप जान सकें:
...
### लाइसेंस
यह प्रोजेक्ट MIT लाइसेंस के तहत लाइसेंस प्राप्त है - अधिक जानकारी के लिए [LICENSE](../../LICENSE) फाइल देखें।
